...
/////////////////// ChatGPT made /////////////////
	public static void main(String[] args) {
		...
		Contact c1 = new Contact("Nawaf", "0533295839", "nawaf4800@gmail.com", "Hatan bin al mali", "09/28/2003",
				"swe");
		Contact c2 = new Contact("Naif", "0533295839", "nawaf4800@gmail.com", "Hatan bin al mali", "09/28/2003", "swe");
		Contact c3 = new Contact("Ziyad", "0533295839", "nawaf4800@gmail.com", "Hatan bin al mali", "09/28/2003",
				"swe");
		Contact c4 = new Contact("Ahmed", "0533295839", "nawaf4800@gmail.com", "Hatan bin al mali", "09/28/2003",
				"swe");

		System.out.println(bst.empty());
		bst.insertContact(c1);
		bst.insertContact(c2);
		bst.insertContact(c3);
		bst.insertContact(c4);
		System.out.println(bst.empty());
		System.out.println(c1.getContactKey());
		System.out.println(c2.getContactKey());
		System.out.println(c3.getContactKey());
		System.out.println(c4.getContactKey());
		bst.removeKey(c1.contactKey);
		bst.removeKey(c2.contactKey);
		bst.removeKey(c3.contactKey);
		bst.removeKey(c4.contactKey);
		System.out.println(bst.empty());
	}
